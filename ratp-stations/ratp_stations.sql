...
UPDATE ratp_stations SET line = '6' WHERE "name" IN ('Bir-Hakeim (Grenelle)','Cambronne','Chevaleret','Corvisart','Dupleix','Glacière','Quai de la Gare','Sèvres-Lecourbe','Bel-Air','Passy','Saint-Jacques','Boissière','Dugommier','Edgar-Quinet','Kléber','Picpus')
...
UPDATE ratp_stations SET line = 'B' WHERE "name" IN ('Aéroport Charles de Gaulle 1','Aéroport Charles de Gaulle 2 TGV','Antony','Arcueil-Cachan','Aulnay-sous-Bois','Bagneux','Bourg-la-Reine','Bures-sur-Yvette','Cité Universitaire','Courcelle-sur-Yvette','Drancy','Fontaine-Michalon','Fontenay-aux-Roses','Gentilly','Gif-sur-Yvette','La Courneuve-Aubervilliers','La Croix-de-Berny','La Hacquinière','La Plaine-Stade de France','Laplace','Le Blanc-Mesnil','Le Bourget','Le Guichet','Les Baconnets','Lozère','Luxembourg','Massy-Palaiseau','Massy-Verrières','Mitry-Claye','Orsay-Ville','Palaiseau','Palaiseau Villebon','Parc de Sceaux','Parc des Expositions','Port-Royal','Robinson','Saint-Rémy-lès-Chevreuse','Sceaux','Sevran-Beaudottes','Sevran Livry','Vert-Galant','Villeparisis','Villepinte')
...
-- La Motte-Picquet-Grenelle, Bercy, Charles de Gaulle - Étoile, Daumesnil, Denfert-Rochereau, Montparnasse - Bienvenüe, Nation, Place d'Italie, Raspail, Trocadéro
UPDATE ratp_stations SET line = '6' WHERE "coordinates" IN ('48.8490189283,2.29776216071','48.840542783,2.37940946312','48.8739938407,2.29466396183','48.8396821402,2.39558417035','48.8339982367,2.33323850116','48.8440276362,2.32356979722','48.8474552623,2.39777174361','48.8312826555,2.35545587036','48.8391569815,2.33047415116','48.863089135,2.28684037849')
...
UPDATE ratp_stations SET line = '7' WHERE "coordinates" IN ('48.8840719864,2.36887006278','48.8572036455,2.34722471106','48.8728599894,2.33304475093', '48.876695836,2.35799251055','48.8459684322,2.35480739269','48.8809004282,2.36510721826','48.8706310801,2.33173704836','48.8623718215,2.33657360074','48.8311118383,2.35579614571','48.8666138306,2.33440753095')
...
-- Concorde, Madeleine, Marcadet - Poissonniers, Montparnasse - Bienvenüe, Pigalle, Saint-Lazare, Sèvres-Babylone,
UPDATE ratp_stations SET line = '12' WHERE "coordinates" IN ('48.8654893909,2.32141178921','48.8695071276,2.32468019959','48.8916068227,2.34954831099','48.8420770202,2.32101044956','48.8820270896,2.33721380175','48.8754209778,2.32669527207','48.851577469,2.32689078834')
