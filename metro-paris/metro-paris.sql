...
CREATE TABLE metro_paris (
	ligne VARCHAR,
	parcours VARCHAR,
	mise_en_service INTEGER,
	dernier_prolongement INTEGER,
	longueur_km_surface DOUBLE PRECISION,
	nombre_stations INTEGER,
	materiel VARCHAR,
	voitures_par_rame INTEGER,
	nombre_rames_pointe INTEGER,
	nombre_total_rames INTEGER,
	millions_voyageurs_2017 DOUBLE PRECISION,
);
